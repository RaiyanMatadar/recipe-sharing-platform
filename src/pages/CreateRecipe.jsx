    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2 font-serif">Create New Recipe</h1>
          <p className="text-gray-500">Share your culinary creation with the world</p>
        </div>
